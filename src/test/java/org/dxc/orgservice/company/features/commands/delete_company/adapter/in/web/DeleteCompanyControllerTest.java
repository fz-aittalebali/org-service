...
class DeleteCompanyControllerTest extends AbstractControllerTest {
    ...
    class Deleted {
        ...
        void should_return_204() throws Exception {
            ...
            mockMvc.perform(delete("/api/v1/companies/{id}", COMPANY_ID).with(adminJwt()))
    ...
    class Security {
        ...
        void should_return_403() throws Exception {
            mockMvc.perform(delete("/api/v1/companies/{id}", COMPANY_ID).with(nonAdminJwt()))
