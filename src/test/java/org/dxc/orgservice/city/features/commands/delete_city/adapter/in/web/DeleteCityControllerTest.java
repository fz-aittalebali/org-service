...
@WebMvcTest(DeleteCityController.class)
@DisplayName("DELETE /api/v1/cities/{id}")
class DeleteCityControllerTest extends AbstractControllerTest {

    @MockitoBean
    private IDeleteCityHandler handler;
    ...
    class Deleted {
        ...
        void should_return_204() throws Exception {
            ...
            mockMvc.perform(delete("/api/v1/cities/{id}", CITY_ID).with(adminJwt()))
    ...
    class Security {
        ...
        void should_return_401() throws Exception {
            mockMvc.perform(delete("/api/v1/cities/{id}", CITY_ID))
        ...
        void should_return_403() throws Exception {
            mockMvc.perform(delete("/api/v1/cities/{id}", CITY_ID).with(nonAdminJwt()))
