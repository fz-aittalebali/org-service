...
@WebMvcTest(DeleteCampusController.class)
@DisplayName("DELETE /api/v1/campuses/{id}")
class DeleteCampusControllerTest extends AbstractControllerTest {

    @MockitoBean
    private IDeleteCampusHandler handler;
    ...
    class Deleted {
        ...
        void should_return_204() throws Exception {
            ...
            mockMvc.perform(delete("/api/v1/campuses/{id}", CAMPUS_ID).with(adminJwt()))
    ...
    class Security {
        ...
        void should_return_401() throws Exception {
            mockMvc.perform(delete("/api/v1/campuses/{id}", CAMPUS_ID))
        ...
        void should_return_403() throws Exception {
            mockMvc.perform(delete("/api/v1/campuses/{id}", CAMPUS_ID).with(nonAdminJwt()))
