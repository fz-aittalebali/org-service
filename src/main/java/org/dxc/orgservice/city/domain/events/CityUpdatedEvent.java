...
public final class CityUpdatedEvent extends AbstractDomainEvent<UUID> {
    private final String name;
    private final String zipCode;
    private final UUID countryId;

    public CityUpdatedEvent(UUID cityId, String name, String zipCode, UUID countryId, Instant occurredOn) {
